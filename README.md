...
**DBBI prime markers as framing metadata (2026-09-15):** [runs/2026-09-15_dbbi_framing_architect/REPORT.md](runs/2026-09-15_dbbi_framing_architect/REPORT.md). The exact 83-cell parse was retained: 23 prime boundaries split all 60 ordinary cells into 24 ordered gaps, with no prime token used as a value. Gap lengths, terminal ordinary values, all/blue/yellow whole-gap reversals, and row-local indexing into both 24-row Kedri/spelled Architect edit tables produced 518 candidates (118 complete, 62 unique). There were 0 exact differential matches and 0 instruction-oracle hits; the best English score was reached or exceeded by 471/5,000 fixed-gap shuffled controls. Direct ordered-vector comparisons were also null (gap lengths p=.086; terminal values p=.530). This closes the direct framing-to-Architect indexing/reversal family, not other operations on the preserved 60-character payload.

**FAED 5/479/484 anchors over DBBI logical cells (2026-09-15):** [runs/2026-09-15_faed_anchor_dbbi/REPORT.md](runs/2026-09-15_faed_anchor_dbbi/REPORT.md). This implements the balanced-pointer continuation directly on complete DBBI logical cells, never raw offsets: FAED anchors under both index bases, symmetric neighborhoods through radius 12, both directions and color schedules, and five prime-cell arithmetic modes, with all ordinary values preserved. The accounting conflict is explicit: 84 cells means 23 prime + **61** ordinary; 23 prime + **60** ordinary is the 83-cell control. **1,040 candidates / 940 unique streams, 0 ordinary round-trip failures, 0 known-string matches.** Bifid continuations max at 15 versus control max 21 (229/20,000 controls score at least 15), so no apparent fragment exceeds noise. This closes literal short-neighborhood replacement/arithmetic at prime cells, not anchors as lengths or traversals over the ordinary payload.
